...
- Optimizes XGB params on val set RMSE.
...
DEFAULT_TRAIN = Path("data/processed/fe_train.csv")
...
def tune_model(
    ...
    X_train, y_train, X_val, y_val = _load_data(train_path, val_path, sample_frac, random_state)
